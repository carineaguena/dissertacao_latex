...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.5]{diagrama_classe_interacao_nosql.png}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.5]{diagrama_classe_inventario.png}
...
\begin{itemize}
	...
	\item Python 2.7: Linguagem de programação orientada a objetos. Disponível em: https://www.python.org/download/releases/2.7/;
	
	\item LiClipse 3.4.0: plataforma de programação (IDE) open-source. Disponível em: http://www.liclipse.com/download.html;
	
	\item SGBD MariaDB versão 10.0.27. Disponível em: https://downloads.mariadb.org/mariadb/10.0.27/;
...
\subsection{Esquema de Dados Abstrato}

Esquema de dados é uma classe abstrata que determina o comportamento e os atributos de um esquema de dados generalizado, as classes que derivam dela são as variações de esquemas que existem por conta dos vários paradigmas de armazenamento de dados presentes na literatura. A Figura X.X mostra a implementação dessa classe.
