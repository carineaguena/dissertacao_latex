...
O aumento do uso de Banco de Dados com esquemas não relacionais e a falta de uma ferramenta programável, flexível e integrada que dê suporte à extração, transformação e carga em Data Warehouses, bem como, a falta de um modelo que seja independente de plataforma que auxilie na análise de dados, é a grande motivação deste trabalho.
